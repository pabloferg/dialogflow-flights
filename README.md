...
For the sake of simplicity, at the moment this code only works for routes operated by British Airways from Heathrow Airport and for one passenger. Changing this is as easy as modifying some values in the API call.
